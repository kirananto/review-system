...
// Source: internal/api/service/models.go
...
// CreateReview indicates an expected call of Createmodels.
...
// DeleteReview indicates an expected call of Deletemodels.
...
func (m *MockReviewService) GetReviewByID(ctx context.Context, id uint) (*models.Review, error) {
	m.ctrl.T.Helper()
...
func (m *MockReviewService) GetReviews(ctx context.Context) ([]*models.Review, error) {
	m.ctrl.T.Helper()
...
func (m *MockReviewService) UpdateReview(ctx context.Context, review *models.Review) error {
	m.ctrl.T.Helper()
...
// UpdateReview indicates an expected call of Updatemodels.
